...
ax3.plot(m,prof1, label="1000 Yuan")
ax3.plot([1.25,1.25],[0,3], color="orange")
ax3.plot([2.50,2.50],[0,3], color="orange")
ax3.plot([5.00,5.00],[0,3], color="orange")
ax3.plot([7.50,7.50],[0,3], color="orange")
ax3.set_xlabel("Annual Cost (10000 Yuan)")
ax3.set_ylabel("Annual Sale Profit (10000 Yuan per person)")
ax3.set_ylim(0,2.5)